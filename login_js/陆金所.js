        ...
        if (!lufax.util.fingerPrint) {
            var n = function() {
                function t() {
                    ...
                    t.plugins = r;
                    for (var u = navigator.mimeTypes.length, p = [], g = 0; g < u; g++) {
                        var f = {}
                          , l = "";
                ...
                function s() {
                    return h() ? u() : "WebGL not supported in this browser."
                }
                function c() {
                ...
                function _(t, e) {
                    t = t || "",
                    e = e || 0;
                    for (var r = t.length % 16, n = t.length - r, i = [0, e], o = [0, e], a = [0, 0], s = [0, 0], c = [2277735313, 289559509], h = [1291169091, 658871167], u = 0; u < n; u += 16)
                    ...
                    r) {
                    case 15:
                        s = E(s, y([0, t.charCodeAt(u + 14)], 48));
                    case 14:
                        s = E(s, y([0, t.charCodeAt(u + 13)], 40));
                    case 13:
                        s = E(s, y([0, t.charCodeAt(u + 12)], 32));
                    case 12:
                        s = E(s, y([0, t.charCodeAt(u + 11)], 24));
                    case 11:
                        s = E(s, y([0, t.charCodeAt(u + 10)], 16));
                    case 10:
                        s = E(s, y([0, t.charCodeAt(u + 9)], 8));
                    case 9:
                        s = E(s, [0, t.charCodeAt(u + 8)]),
                        s = b(s, h),
                        s = w(s, 33),
                        s = b(s, c),
                        o = E(o, s);
                    case 8:
                        a = E(a, y([0, t.charCodeAt(u + 7)], 56));
                    case 7:
                        a = E(a, y([0, t.charCodeAt(u + 6)], 48));
                    case 6:
                        a = E(a, y([0, t.charCodeAt(u + 5)], 40));
                    case 5:
                        a = E(a, y([0, t.charCodeAt(u + 4)], 32));
                    case 4:
                        a = E(a, y([0, t.charCodeAt(u + 3)], 24));
                    case 3:
                        a = E(a, y([0, t.charCodeAt(u + 2)], 16));
                    case 2:
                        a = E(a, y([0, t.charCodeAt(u + 1)], 8));
                    case 1:
                        a = E(a, [0, t.charCodeAt(u)]),
                        a = b(a, c),
                        a = w(a, 31),
                        a = b(a, h),
                        i = E(i, a)
                ...
                var x, T, I = t(), R = (l(),
                _(s().toString(), 31)), B = _(g().toString(), 31);
                return {
                    getFingerPrintInfo: function() {
                        return x ? x : x = {
                            navigatorInfo: I,
                            webglFingerPrintInfo: R,
                            canvasFingerPrintInfo: B
                        }
                    },
                    ...
                    sendFingerPrintInfo: function(t) {
                        function n(t) {
                            return t = t.split("."),
                        ...
                        var a = this.getAesEncriptedFingerPrintInfoForInfoWeb()
                          , s = new RSAKey;
                        s.setPublic(e, r),
                        a.deviceKey = s.encrypt(a.deviceKey);
                        var c = [];
                        for (var h in a)
                            a.hasOwnProperty(h) && c.push(encodeURIComponent(h) + "=" + encodeURIComponent(a[h]));
                        var u = c.join("&")
                          , p = window._fp_url;
                        if (!p) {
                            var g = n(location.hostname);
                            p = i(location.hostname) + g + "/sec-info/service/mq/accept-device-info"
                        }
                        o(p, u, t)
                    },
                    fingerPrintIsOk: function(t) {
                        "success" === T ? t && t(T) : this.sendFingerPrintInfo(t)
                    }
                }
            }();
            setTimeout(function() {
            ...
            void 0 === window.lufax && (window.lufax = {}),
            void 0 === window.lufax.util && (window.lufax.util = {}),
