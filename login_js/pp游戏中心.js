...
function kwyword(username, password, code){
i = "type=ajax&from=" + "web" + "&username=" + username + "&password=" + password + "&vcode=" + code + "&appplt=" + "web" + "&appid=" + "vas" + "&channel=" + "208000103007" + "&sceneFlag=" + "q";
